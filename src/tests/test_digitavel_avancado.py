...
class TestDigitavelAvancado:
    ...
    def test_regex_avancado_padroes_flexiveis(self):
        ...
        digitavel_teste = Digitavel.gerar_digitavel_valido(banco="033", valor=100.00, vencimento_dias=30)
    ...
    def test_regex_avancado_extracao_inteligente(self):
        ...
        digitaveis_raw = [
            Digitavel.gerar_digitavel_valido(banco="001", valor=50.00, vencimento_dias=15),
            Digitavel.gerar_digitavel_valido(banco="033", valor=150.00, vencimento_dias=30),
            Digitavel.gerar_digitavel_valido(banco="104", valor=300.00, vencimento_dias=45),
        ]
    ...
    def test_regex_avancado_validacao_robusta(self):
        ...
        digitavel_valido = Digitavel.gerar_digitavel_valido(banco="033", valor=200.00, vencimento_dias=60)
    ...
    def test_regex_avancado_substituicao_inteligente(self):
        ...
        texto_normalizado = regex.sub(padrao_normalizacao, substituicao, texto_inconsistente)
...
def test_regex_falha_padroes_malformados():
    ...
    texto_valido = "Linha Digitável: 03391.2346 56789.01231 41234.567802 1 101880000025000"
        ...
        for j, match in enumerate(matches):
            ...
            try:
                ...
                if digitavel_obj.validar():
                    ...
                    logger.warning(f"  ⚠️ Match {j+1}: Inválido - {digitavel_encontrado}")
            except Exception as e:
