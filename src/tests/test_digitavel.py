...
from ..core.digitavel import CamposDigitavel, Digitavel
...
def test_casos_edge_modulo_11():
    ...
    digitavel._calcular_modulo_11(numero_resto_zero)
    ...
    digitavel._calcular_modulo_11(numero_resto_um)
...
def test_gerar_digitavel_valido():
    ...
    digitavel2 = Digitavel.gerar_digitavel_valido(
...
def test_digitavel_com_dv_geral_errado():
    ...
    if digitavel._campos:
        ...
        codigo_sem_dv = (
            digitavel.valor[0:4]
            + digitavel._campos.campo_livre
            + digitavel._campos.fator_valor_e_valor
        )
        ...
        print("✅ DV geral incorreto detectado corretamente")
...
def test_digitavel_com_tamanhos_incorretos():
    ...
    casos_tamanho = [
        ...
        (
            ...
            "Muito longo (60 dígitos)",
        ),
        (
            "123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890",
            "Extremamente longo (80 dígitos)",
        ),
        ("", "Vazio"),
        ("1", "Apenas 1 dígito"),
        ("12", "Apenas 2 dígitos"),
...
def test_properties_com_digitavel_invalido():
    ...
    digitavel_dv_errado = Digitavel(
        "033991614.9 0700000191.9 8155600101.9 9 11370000038936"
    )
